 ...
 * Categoría nueva (no forzada dentro de "datos"): el editor "edi" es una
 * aplicación interactiva completa, no una demo puntual de una syscall.
 * Ver la justificación detallada en el comentario de cabecera de cat_editor.c
 * y en el documento de sustentación (PDF). */
int cmd_editor(int argc, char **argv); /* Syscalls: readlink, fork, execve, waitpid */
